...
import './Navbar.css'
import { onLogoutUser, searchNav } from '../actions/index'
...
export class navbar extends React.Component {
  ...
  onSearchClick = (navSearch) => {
      navSearch.preventDefault()
      this.props.searchNav(this.state.hasil)
  }

  render() {
    console.log(this.props.hasilSearch);
        ...
        <div>
          <Navbar style={{ backgroundColor: '#e0143d', fontSize: '9px' }} expand="md">
            ...
            <div className='search'>
              <Input value={this.state.hasil} onChange={e => this.setState({hasil: e.target.value})} type='text' className='search-box' placeholder='Aku mau belanja' />
            </div>

            <button onClick={this.onSearchClick} type="button" className="btn btn-outline-light mx-2">Search</button>
...
const mstp = state => {
  return {
    ...
    hasilSearch: state.search.keyword,
    roleUsers: state.auth.role
  }
}

export default connect(mstp, { onLogoutUser,searchNav })(navbar)